...
class MB_Select extends HTMLElement
{
  ...
  Render_Clear_Option()
  {
    ...
    select_elem.type = "button";
    select_elem.classList.add("mb_option_btn");
    select_elem.innerText = this.getAttribute("def-label") || "";
    select_elem.addEventListener("click", this.On_Click_Clear);
  ...
  async Render_Menu(id)
  {
    ...
    menu_elem.append(this.Render_Clear_Option());
